...
Clone, move into directory and start react dev environment

```
git clone https://github.com/ar-to/react-fetch-tests.git
cd react-fetch-tests
npm start
```
Below are the table of contents that come default with a new create-react-app
